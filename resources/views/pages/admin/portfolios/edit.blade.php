    ...
    <div class="row">
        <div class="col-md-3 form-group mt-3">
            <div class="big_img mb-5">
                <h4>Big Image</h4>
                <img class="my-2" width="200" src="{{url($portfolio->big_img)}}" class="big_img">
                <input type="file" name="big_img" >
            </div>

            <div class="small_img">
                <h4>Small Image</h4>
                <img class="my-2" width="200" src="{{url($portfolio->small_img)}}" class="big_img">
        ...
        <div class="col-md-4 form-group mt-3">
            ...
            <div class="category mt-3">
                ...
                <input type="text" name="category" value="{{$portfolio->category}}" class="form-control" >
            </div>
